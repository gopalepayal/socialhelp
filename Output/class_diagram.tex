...
% Title
\node[font=\LARGE\bfseries, align=center] at (0, 6.5) {UML Class Diagram - Social Help and Donation System};
...
\draw[->, thick] (Admin.south) -- (Donation.north)
    node[pos=0.1, right=0.1cm, font=\small\bfseries] {1}
    node[midway, right=0.1cm, font=\small] {Manages}
    node[pos=0.9, right=0.1cm, font=\small\bfseries] {*};
