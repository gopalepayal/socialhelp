...
% Admin -> Donation (Manages) - orthogonal path from bottom-left to center
\draw[->, thick] (Admin.north) -- (-8, -1) -- (Donation.west)
    node[pos=0.1, left=0.1cm, font=\small\bfseries] {1}
    node[pos=0.6, above, font=\small] {Manages}
    node[pos=0.95, above, font=\small\bfseries] {*};
