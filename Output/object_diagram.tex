...
% Title
\node[font=\LARGE\bfseries, align=center] at (1.5, 4.5) {UML Object Diagram - Social Help and Donation System};
...
% donation1 -> org1
\draw[->, thick] (donation1.east) -- (org1.west) 
    node[midway, above, font=\small] {Receives};

% donation1 -> req1 (Vertical, Fulfills)
\draw[->, thick] (donation1.south) -- (req1.north) 
    node[midway, left=0.1cm, font=\small] {Fulfills};

% chat1 -> req1
\draw[->, thick] (chat1.west) -- (req1.east) 
    node[midway, above=0.05cm, font=\small] {Discusses};

% org1 -> chat1 (No Arrow Head)
\draw[-, thick] (org1.south) -- (chat1.north) 
    node[midway, right=0.1cm, font=\small] {Sends};
